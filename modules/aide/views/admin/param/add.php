...
<form id="key-value-form" class="form form-horizontal" method="post">
  ...
  <div class="form-group">
    ...
    <div class="col-sm-9">
      <input name="name" type="text" placeholder="键" class="form-control input-sm" value="" />
    </div>
  </div>
  ...
  <div class="form-group">
    ...
    <div class="col-sm-8">
        <label class="radio-inline">
          <input type="radio" checked name="type" value="string"> 字符串
        </label> 
        <label class="radio-inline">
          <input type="radio" name="type" value="array"> 数 组
        </label> 
        <label class="radio-inline">
          <input type="radio" name="type" value="dictory"> 键值对
        </label>
    </div>
    <label class="col-sm-1 control-label">
       <a id="add-item-btn" style="display:none"
   ...
   <div id="key-value-string" class="value-box">
       <div class="form-group">
        <label class="col-sm-2 control-label">值：</label>
            <div class="col-sm-9">
                <input type="text" name="value" value="" placeholder="值"
                       class="form-control input-sm" />
            </div>
       </div>
   </div>

   <div id="key-value-array" style="display:none;" class="value-box">
       <div class="form-group">
   ...
   <div id="key-value-dictory" style="display:none;" class="value-box">
       <div class="form-group">
            <label class="col-sm-2 control-label">项：</label>
            <div class="col-sm-4">
